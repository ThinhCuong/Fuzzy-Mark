...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FuzzyMark",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9FuzzyMark10CustomView")
...
SWIFT_CLASS("_TtC9FuzzyMark13CustomeButton")
@interface CustomeButton : UIButton
/// Renders vertical gradient if true else horizontal
@property (nonatomic) BOOL verticalGradient;
...
SWIFT_CLASS("_TtC9FuzzyMark11TJTextField")
