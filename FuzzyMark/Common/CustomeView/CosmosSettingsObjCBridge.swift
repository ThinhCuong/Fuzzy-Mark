...
@objc public class CosmosSettingsObjCBridge: NSObject {
     ...
     */
    @objc public class func setUpdateOnTouch(_ value: Bool, inCosmosView cosmosView: CosmosView) {
    ...
    @objc public class func setDidTouchCosmos(_ didTouchCosmos: @escaping ((Double)->()), cosmosView: CosmosView) {
